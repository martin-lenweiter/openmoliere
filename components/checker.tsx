...
export function Checker() {
	const [text, setText] = usePersistedState("proofread-text", "");
	const [language, setLanguage] = usePersistedState("proofread-lang", "");
				...
				<div className="flex items-center justify-between gap-3">
					<div className="flex items-center gap-3">
						<select
							...
							className="h-11 rounded-md border border-input bg-background px-3 text-sm text-foreground outline-none focus:border-[2px]"
						>
							{LANGUAGES.map((l) => (
